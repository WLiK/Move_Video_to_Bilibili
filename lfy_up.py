...
def fileadd_begin_end(video_path, v_name, dir):
    ...
    # final_clip.to_videofile(dir + '/' + v_name + 'lfy.mp4', remove_temp=False)
    final_clip.write_videofile(dir + '/' + v_name + 'lfy.mp4', audio=True, audio_codec='aac')
    os.remove(video_path)

    os.rename(dir + '/' + v_name + '.info.json',dir + '/' + v_name + 'lfy.info.json')
    os.rename(dir + '/' + v_name + '.jpg',dir + '/' + v_name + 'lfy.jpg')
    return dir + '/' + v_name + 'lfy.mp4', v_name + 'lfy'
...
if __name__ == '__main__':
    ...
    # login
    uploader.login("18392487241", "wlk4040768")
    # uploader = None
    ...
    for v in video_list:
        ...
        fileAppend(video_path)
        video_path, v_name = fileadd_begin_end(video_path, v_name, dir)
